...
class RainfallTest {
    ...
    @Test
    fun test1() {
        println("Fixed Tests: mean data of LONDON")
        assertFuzzyEquals(mean("London", RainfallTest.data), 51.199999999999996)
    }

    @Test
    fun test2() {
        println("Fixed Tests: variance data of LONDON")
        assertFuzzyEquals(variance("London", RainfallTest.data), 57.42833333333374)
    }

    @Test
    fun test3() {
        println("Fixed Tests: mean data of LON")
        assertFuzzyEquals(mean("Lon", RainfallTest.data), -1.0)
    }
